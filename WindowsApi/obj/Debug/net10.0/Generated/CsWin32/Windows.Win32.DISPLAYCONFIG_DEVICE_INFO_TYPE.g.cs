...
namespace Windows.Win32
{
	namespace Devices.Display
	{
		...
		/// <remarks>
		/// <para><see href="https://learn.microsoft.com/windows/win32/api/wingdi/ne-wingdi-displayconfig_device_info_type">Learn more about this API from learn.microsoft.com</see>.</para>
		/// </remarks>
		...
		public enum DISPLAYCONFIG_DEVICE_INFO_TYPE
		{
			...
			/// <para><see href="https://learn.microsoft.com/windows/win32/api/wingdi/ne-wingdi-displayconfig_device_info_type#members">Read more on learn.microsoft.com</see>.</para>
			/// </summary>

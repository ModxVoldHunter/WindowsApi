...
namespace Windows.Win32
{
	namespace System.Diagnostics.ProcessSnapshotting
	{
		...
		/// <remarks>If both <b>PSS_CREATE_FORCE_BREAKAWAY</b> and <b>PSS_CREATE_BREAKAWAY</b> are specified, then <b>PSS_CREATE_FORCE_BREAKAWAY</b> takes precedence.</remarks>
		[Flags]
		...
		public enum PSS_CAPTURE_FLAGS : uint
		{
			...
			/// <para><see href="https://learn.microsoft.com/windows/win32/api/processsnapshot/ne-processsnapshot-pss_capture_flags#members">Read more on learn.microsoft.com</see>.</para>
			/// </summary>
			...
			/// <summary>
			/// <para>The virtual address (VA) clone process does not hold a reference to the underlying image. This will cause functions such as <a href="https://docs.microsoft.com/windows/desktop/api/winbase/nf-winbase-queryfullprocessimagenamea">QueryFullProcessImageName</a> to fail on the VA clone process. <div class="alert"><b>Important</b>  <p class="note"> This flag has no effect unless <b>PSS_CAPTURE_VA_CLONE</b> is specified. </div> <div> </div></para>
			/// <para><see href="https://learn.microsoft.com/windows/win32/api/processsnapshot/ne-processsnapshot-pss_capture_flags#members">Read more on learn.microsoft.com</see>.</para>
			/// </summary>

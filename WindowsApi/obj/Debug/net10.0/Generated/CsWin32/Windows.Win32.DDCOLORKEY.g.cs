...
namespace Windows.Win32
{
	...
	{
		/// <summary>The DDCOLORKEY structure describes a source color key, destination color key, or color space.</summary>
		/// <remarks>
		/// <para><see href="https://learn.microsoft.com/windows/win32/api/ddraw/ns-ddraw-ddcolorkey">Learn more about this API from learn.microsoft.com</see>.</para>
		/// </remarks>

...
namespace Windows.Win32
{
	...
	public partial class DestroyCursorSafeHandle
		:SafeHandle	{
		private static readonly IntPtr INVALID_HANDLE_VALUE = new IntPtr(-1L);

		public DestroyCursorSafeHandle():base(INVALID_HANDLE_VALUE, true)
		{
		}

		public DestroyCursorSafeHandle(IntPtr preexistingHandle, bool ownsHandle = true):base(INVALID_HANDLE_VALUE, ownsHandle)
		{

...
namespace Windows.Win32
{
	namespace UI.WindowsAndMessaging
	{
		...
		/// <para><see href="https://learn.microsoft.com/windows/win32/api/winuser/ns-winuser-menuiteminfow#">Read more on learn.microsoft.com</see>.</para>
		/// </remarks>
		...
		public partial struct MENUITEMINFOW
		{
			...
			/// <para><see href="https://learn.microsoft.com/windows/win32/api/winuser/ns-winuser-menuiteminfow#members">Read more on learn.microsoft.com</see>.</para>
			/// </summary>
			public uint cbSize;

			/// <summary>Type: <b>UINT</b></summary>
			public winmdroot.UI.WindowsAndMessaging.MENU_ITEM_MASK fMask;

			/// <summary>Type: <b>UINT</b></summary>
			public winmdroot.UI.WindowsAndMessaging.MENU_ITEM_TYPE fType;
			...
			/// <para><see href="https://learn.microsoft.com/windows/win32/api/winuser/ns-winuser-menuiteminfow#members">Read more on learn.microsoft.com</see>.</para>
			/// </summary>
			public winmdroot.UI.WindowsAndMessaging.MENU_ITEM_STATE fState;
			...
			/// <para><see href="https://learn.microsoft.com/windows/win32/api/winuser/ns-winuser-menuiteminfow#members">Read more on learn.microsoft.com</see>.</para>
			/// </summary>
			public winmdroot.UI.WindowsAndMessaging.HMENU hSubMenu;
			...
			/// <para><see href="https://learn.microsoft.com/windows/win32/api/winuser/ns-winuser-menuiteminfow#members">Read more on learn.microsoft.com</see>.</para>
			/// </summary>
			public winmdroot.Graphics.Gdi.HBITMAP hbmpChecked;
			...
			/// <para><see href="https://learn.microsoft.com/windows/win32/api/winuser/ns-winuser-menuiteminfow#members">Read more on learn.microsoft.com</see>.</para>
			/// </summary>
			public winmdroot.Graphics.Gdi.HBITMAP hbmpUnchecked;
			...
			/// <para><see href="https://learn.microsoft.com/windows/win32/api/winuser/ns-winuser-menuiteminfow#members">Read more on learn.microsoft.com</see>.</para>
			/// </summary>
			public winmdroot.Foundation.PWSTR dwTypeData;
			...
			/// <para><see href="https://learn.microsoft.com/windows/win32/api/winuser/ns-winuser-menuiteminfow#members">Read more on learn.microsoft.com</see>.</para>
			/// </summary>
			public winmdroot.Graphics.Gdi.HBITMAP hbmpItem;
		}
	}
}

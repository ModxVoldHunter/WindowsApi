...
namespace Windows.Win32
{
	namespace Graphics.GdiPlus
	{
		...
		public partial struct EncoderParameters
		{
			...
			public global::Windows.Win32.VariableLengthInlineArray<winmdroot.Graphics.GdiPlus.EncoderParameter> Parameter;
			...
			{
				int v = sizeof(EncoderParameters);
				if (count > 1)
					v +=checked((count - 1) * sizeof(winmdroot.Graphics.GdiPlus.EncoderParameter));
					else
						if (count < 0)

...
namespace Windows.Win32
{
	...
	public partial class LocalFreeSafeHandle
		:SafeHandle	{
		private static readonly IntPtr INVALID_HANDLE_VALUE = new IntPtr(-1L);

		public LocalFreeSafeHandle():base(INVALID_HANDLE_VALUE, true)
		{
		}

		public LocalFreeSafeHandle(IntPtr preexistingHandle, bool ownsHandle = true):base(INVALID_HANDLE_VALUE, ownsHandle)
		{

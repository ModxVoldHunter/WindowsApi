...
namespace Windows.Win32
{
	...
	{
		/// <summary>The MODULEENTRY32W (Unicode) structure (tlhelp32.h) describes an entry from a list of the modules belonging to the specified process.</summary>
		...
		public partial struct MODULEENTRY32W
		{
			/// <summary>
			...
			/// <para><see href="https://learn.microsoft.com/windows/win32/api/tlhelp32/ns-tlhelp32-moduleentry32w#members">Read more on learn.microsoft.com</see>.</para>
			/// </summary>
			public uint dwSize;
			...
			public winmdroot.__char_256 szModule;

			/// <summary>The module path.</summary>
			public winmdroot.__char_260 szExePath;
		}
	}
}

...
namespace Windows.Wdk
{
	namespace Graphics.Direct3D
	{
		...
		public partial struct D3DDDI_SYNCHRONIZATIONOBJECT_FLAGS
		{
...
set => this._bitfield = (uint)(value ? this._bitfield | 0x00000020 : (this._bitfield & unchecked((uint)~0x00000020)));
					...
					public bool NoSignalMaxValueOnTdr
					{
												[MethodImpl(MethodImplOptions.AggressiveInlining)]
...
set => this._bitfield = (uint)(value ? this._bitfield | 0x00000100 : (this._bitfield & unchecked((uint)~0x00000100)));
					...
					public bool LocalMemoryPreferred
					{
												[MethodImpl(MethodImplOptions.AggressiveInlining)]
...
set => this._bitfield = (uint)(value ? this._bitfield | 0x00000200 : (this._bitfield & unchecked((uint)~0x00000200)));
					...
					/// <summary>Gets or sets bits 10-30 in the <see cref="_bitfield" /> field. Allowed values are [0..2097151].</summary>
					public uint Reserved
					{
												[MethodImpl(MethodImplOptions.AggressiveInlining)]
readonly get => (uint)((this._bitfield >> 10) & 0x001FFFFF);
												[MethodImpl(MethodImplOptions.AggressiveInlining)]
set
						{
							global::System.Diagnostics.Debug.Assert(value is <= (uint)2097151L);
							this._bitfield = (uint)((this._bitfield & unchecked((uint)~0x7FFFFC00)) | ((uint)(value & 0x001FFFFF) << 10));
						}
					}

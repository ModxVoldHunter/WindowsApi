...
namespace Windows.Win32
{
	namespace UI.Input.KeyboardAndMouse
	{
		...
		/// <para><see href="https://learn.microsoft.com/windows/win32/api/winuser/ns-winuser-trackmouseevent#">Read more on learn.microsoft.com</see>.</para>
		/// </remarks>
		...
		public partial struct TRACKMOUSEEVENT
		{
			...
			/// <para><see href="https://learn.microsoft.com/windows/win32/api/winuser/ns-winuser-trackmouseevent#members">Read more on learn.microsoft.com</see>.</para>
			/// </summary>
			public uint cbSize;

			/// <summary>Type: <b>DWORD</b></summary>
			public winmdroot.UI.Input.KeyboardAndMouse.TRACKMOUSEEVENT_FLAGS dwFlags;

			/// <summary>
			/// <para>Type: <b>HWND</b> A handle to the window to track.</para>
			/// <para><see href="https://learn.microsoft.com/windows/win32/api/winuser/ns-winuser-trackmouseevent#members">Read more on learn.microsoft.com</see>.</para>
			/// </summary>
			public winmdroot.Foundation.HWND hwndTrack;

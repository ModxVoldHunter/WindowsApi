...
{
	public partial struct __nint_8
	{
		...
		/// </remarks>
		[UnscopedRef]
		public unsafe Span<nint> AsSpan() => MemoryMarshal.CreateSpan(ref _0, SpanLength);
		...
		/// </remarks>
		[UnscopedRef]
		public unsafe readonly ReadOnlySpan<nint> AsReadOnlySpan() => MemoryMarshal.CreateReadOnlySpan(ref Unsafe.AsRef(in _0), SpanLength);

		public static implicit operator __nint_8(ReadOnlySpan<nint> value)
		{
			Unsafe.SkipInit(out __nint_8 result);

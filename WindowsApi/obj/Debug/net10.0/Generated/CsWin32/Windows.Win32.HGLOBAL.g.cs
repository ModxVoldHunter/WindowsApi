...
namespace Windows.Win32
{
	...
	{
		[DebuggerDisplay("{Value}"),NativeMarshalling(typeof(global::Windows.Win32.Foundation.InteropServices.HGLOBALMarshaller))]
		[global::System.CodeDom.Compiler.GeneratedCode("Microsoft.Windows.CsWin32", "0.3.275+02bc0c298e.RR")]
		public unsafe readonly partial struct HGLOBAL
			: IEquatable<HGLOBAL>
		{
			public readonly void* Value;

			public HGLOBAL(void* value) => this.Value = value;

			public HGLOBAL(IntPtr value):this(unchecked((void*)value))
			{
			}
			...
			public static implicit operator IntPtr(HGLOBAL value) => new IntPtr(value.Value);

			public static explicit operator HGLOBAL(IntPtr value) => new HGLOBAL((void*)value.ToPointer());

			public static explicit operator HGLOBAL(UIntPtr value) => new HGLOBAL((void*)value.ToPointer());
		}
	}
}

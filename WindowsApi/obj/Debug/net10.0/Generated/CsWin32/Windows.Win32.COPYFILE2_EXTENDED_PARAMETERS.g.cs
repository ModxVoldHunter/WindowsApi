...
namespace Windows.Win32
{
	namespace Storage.FileSystem
	{
		...
		/// <para><see href="https://learn.microsoft.com/windows/win32/api/winbase/ns-winbase-copyfile2_extended_parameters#">Read more on learn.microsoft.com</see>.</para>
		/// </remarks>
		[global::System.CodeDom.Compiler.GeneratedCode("Microsoft.Windows.CsWin32", "0.3.275+02bc0c298e.RR")]
		public partial struct COPYFILE2_EXTENDED_PARAMETERS
		{
			/// <summary>
			/// <para>Contains the size of this structure, <c>sizeof(COPYFILE2_EXTENDED_PARAMETERS)</c>.</para>
			/// <para><see href="https://learn.microsoft.com/windows/win32/api/winbase/ns-winbase-copyfile2_extended_parameters#members">Read more on learn.microsoft.com</see>.</para>
			/// </summary>
			public uint dwSize;
			...
			/// <para><see href="https://learn.microsoft.com/windows/win32/api/winbase/ns-winbase-copyfile2_extended_parameters#members">Read more on learn.microsoft.com</see>.</para>
			/// </summary>
			public winmdroot.Storage.FileSystem.COPYFILE_FLAGS dwCopyFlags;

			/// <summary>
			/// <para>If this flag is set to <b>TRUE</b> during the copy operation then the copy operation is canceled.</para>
			/// <para><see href="https://learn.microsoft.com/windows/win32/api/winbase/ns-winbase-copyfile2_extended_parameters#members">Read more on learn.microsoft.com</see>.</para>
			/// </summary>
			public unsafe winmdroot.Foundation.BOOL* pfCancel;
			...
			/// <para><see href="https://learn.microsoft.com/windows/win32/api/winbase/ns-winbase-copyfile2_extended_parameters#members">Read more on learn.microsoft.com</see>.</para>
			/// </summary>
			public unsafe delegate *unmanaged[Stdcall]<global::Windows.Win32.Storage.FileSystem.COPYFILE2_MESSAGE*,void*,global::Windows.Win32.Storage.FileSystem.COPYFILE2_MESSAGE_ACTION> pProgressRoutine;
			...
			/// <para><see href="https://learn.microsoft.com/windows/win32/api/winbase/ns-winbase-copyfile2_extended_parameters#members">Read more on learn.microsoft.com</see>.</para>
			/// </summary>
			public unsafe void* pvCallbackContext;
		}
	}
}

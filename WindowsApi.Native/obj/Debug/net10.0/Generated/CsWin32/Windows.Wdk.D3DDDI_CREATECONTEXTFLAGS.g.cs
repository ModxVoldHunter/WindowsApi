...
namespace Windows.Wdk
{
	namespace Graphics.Direct3D
	{
		...
		public partial struct D3DDDI_CREATECONTEXTFLAGS
		{
...
set => this._bitfield = (uint)(value ? this._bitfield | 0x00000004 : (this._bitfield & unchecked((uint)~0x00000004)));
					...
					public bool SynchronizationOnly
					{
												[MethodImpl(MethodImplOptions.AggressiveInlining)]
...
set => this._bitfield = (uint)(value ? this._bitfield | 0x00000020 : (this._bitfield & unchecked((uint)~0x00000020)));
					...
					/// <summary>Gets or sets bits 6-31 in the <see cref="_bitfield" /> field. Allowed values are [0..67108863].</summary>
					public uint Reserved
					{
												[MethodImpl(MethodImplOptions.AggressiveInlining)]
readonly get => (uint)((this._bitfield >> 6) & 0x03FFFFFF);
												[MethodImpl(MethodImplOptions.AggressiveInlining)]
set
						{
							global::System.Diagnostics.Debug.Assert(value is <= (uint)67108863L);
							this._bitfield = (uint)((this._bitfield & unchecked((uint)~0xFFFFFFC0)) | ((uint)(value & 0x03FFFFFF) << 6));
						}
					}
				}
			}

...
namespace Windows.Win32
{
	...
	{
		[DebuggerDisplay("{Value}"),NativeMarshalling(typeof(global::Windows.Win32.UI.Input.Touch.InteropServices.HGESTUREINFOMarshaller))]
		[global::System.CodeDom.Compiler.GeneratedCode("Microsoft.Windows.CsWin32", "0.3.275+02bc0c298e.RR")]
		public unsafe readonly partial struct HGESTUREINFO
			: IEquatable<HGESTUREINFO>
		{
			public readonly void* Value;

			public HGESTUREINFO(void* value) => this.Value = value;

			public HGESTUREINFO(IntPtr value):this(unchecked((void*)value))
			{
			}
			...
			public static implicit operator IntPtr(HGESTUREINFO value) => new IntPtr(value.Value);

			public static explicit operator HGESTUREINFO(IntPtr value) => new HGESTUREINFO((void*)value.ToPointer());

			public static explicit operator HGESTUREINFO(UIntPtr value) => new HGESTUREINFO((void*)value.ToPointer());
		}
	}
}

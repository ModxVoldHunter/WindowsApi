...
namespace Windows.Win32
{
	...
	{
		public partial struct __COLORREF_16
		{
			...
			public winmdroot.Foundation.COLORREF _0,_1,_2,_3,_4,_5,_6,_7,_8,_9,_10,_11,_12,_13,_14,_15;
			...
			/// </remarks>
			[UnscopedRef]
			public unsafe Span<winmdroot.Foundation.COLORREF> AsSpan() => MemoryMarshal.CreateSpan(ref _0, SpanLength);
			...
			/// </remarks>
			[UnscopedRef]
			public unsafe readonly ReadOnlySpan<winmdroot.Foundation.COLORREF> AsReadOnlySpan() => MemoryMarshal.CreateReadOnlySpan(ref Unsafe.AsRef(in _0), SpanLength);
